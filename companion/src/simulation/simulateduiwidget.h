...
class SimulatedUIWidgetTX18S: public SimulatedUIWidget
{
  Q_OBJECT

  public:
    explicit SimulatedUIWidgetTX18S(SimulatorInterface * simulator, QWidget * parent = nullptr);
    virtual ~SimulatedUIWidgetTX18S();

  private:
    Ui::SimulatedUIWidgetTX18S * ui;
};
