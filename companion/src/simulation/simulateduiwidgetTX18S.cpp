...
#include "ui_simulateduiwidgetTX18S.h"

SimulatedUIWidgetTX18S::SimulatedUIWidgetTX18S(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetTX18S)
{
  RadioUiAction * act;
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 90, 80, 35), "TX18S/left_mdl.png", act));

  act = new RadioUiAction(6, QList<int>() << Qt::Key_Left, SIMU_STR_HLP_KEY_LFT, SIMU_STR_HLP_ACT_SYS);
  addRadioWidget(ui->leftbuttons->addArea(QRect(25, 5, 100, 40), "TX18S/left_sys.png", act));

  act = new RadioUiAction(5, QList<int>() << Qt::Key_Right, SIMU_STR_HLP_KEY_RGT, SIMU_STR_HLP_ACT_TELE);
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 180, 80, 35), "TX18S/left_tele.png", act));
  ...
  addRadioWidget(ui->rightbuttons->addArea(QRect(20, 5, 100, 40), "TX18S/right_rtn.png", act));

  act = new RadioUiAction(1, QList<int>() << Qt::Key_PageDown, SIMU_STR_HLP_KEY_PGDN, SIMU_STR_HLP_ACT_PGDN);
  addRadioWidget(ui->leftbuttons->addArea(QRect(60, 140, 80, 35), "TX18S/left.png", act));
  ...
  addRadioWidget(ui->rightbuttons->addArea(QRect(25, 90, 70, 130), "TX18S/right_ent.png", m_mouseMidClickAction));

  addRadioWidget(ui->leftbuttons->addArea(QRect(10, 245, 30, 30), "TX18S/left_scrnsht.png", m_screenshotAction));
...
SimulatedUIWidgetTX18S::~SimulatedUIWidgetTX18S()
{
  delete ui;
}
